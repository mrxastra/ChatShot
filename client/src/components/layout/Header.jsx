...
import Groups from "../specific/Groups";
...
const Header = () => {
  ...
  return (
    <>
      <nav
        id="header"
        className="sticky top-0 w-full py-1 bg-white shadow-lg border border-blue-400"
      >
      ...
      {isNotification && <Suspense fallback={<div>loading...</div>}> <Notification /></Suspense>}
      {isGroup && <Suspense fallback={<div>loading...</div>}> <Groups /></Suspense>}
